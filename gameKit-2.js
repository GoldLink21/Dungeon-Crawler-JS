...
const GameKit = (function(){
    ...
    GameKit.Controls= new class Controls {
         ...
         * @type {Object.<string,{unpressed:boolean,func:()=>void}>}
         */
        #keyEvents={}
        anyPressed() {
        ...
        keyupEvent(e){
            ...
            else if(this.pressed[this.#pairs[e.key]] != undefined){
                this.pressed[this.#pairs[e.key]] = false;
            }
        }
        keydownEvent(e){
            if(!GameKit.options.trackControls){
            ...
            if(this.pressed[e.key] != undefined) {
                ...
                this.pressed[this.#pairs[e.key]] = true;
                ...
                if(this.#pairs[e.key] != undefined) {
                    this.trackKey(this.#pairs[e.key]);
                } else {
                    this.trackKey(e.key);
                }
            }
        ...
        addPressOnceEvent(key,event){
            this.#keyEvents[key]={unpressed:true,func:event}
        }
    }
